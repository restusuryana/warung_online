<footer>
  <div class="container pt-5">
    <div class="row row-content">
      <div class="col-md-6">
        <h1 class="logo-brand">Barokah <span>Sejati</span></h1>
      ...
      <div class="col-md-3 mt-4 mt-sm-0">
        ...
        <p>Jl. Raya Cibodas kp.tegal jati No.Rt08/03, Cibodas, Kec. Bungursari, Kabupaten Purwakarta, Jawa Barat 41181</p>
      </div>
    </div>
    <div class="row row-copy mt-4 mt-sm-0">
      <div class="col-md-6">
        <p>&copy; 2025 Barokah Sejati. All rights reserved.</p>
      </div>
